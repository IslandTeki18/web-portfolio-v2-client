  ...
  return (
    <div className="px-[3%] sm:px-[8.33333%] 2xl:px-[16.666%]">
      <div className="border border-white p-6 text-white flex flex-col gap-2">
        <span className="text-4xl font-extrabold tracking-wide uppercase w-3/4">
          {props.blog.title}
        </span>
        <div className="flex justify-between items-baseline">
          <span className="text-2xl font-medium">{props.blog.subTitle}</span>
          <span className="italic">Posted on {props.blog.datePublished}</span>
        </div>
      </div>
      <div className="bg-white text-dark h-auto p-6">
