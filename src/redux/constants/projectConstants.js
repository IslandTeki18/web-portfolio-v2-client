...
export const PROJECT_DELETE_FEEDBACK_REQUEST =
  "PROJECT_DELETE_FEEDBACK_REQUEST";
export const PROJECT_DELETE_FEEDBACK_SUCCESS =
  "PROJECT_DELETE_FEEDBACK_SUCCESS";
export const PROJECT_DELETE_FEEDBACK_FAIL = "PROJECT_DELETE_FEEDBACK_FAIL";

export const PROJECT_CREATE_FEEDBACK_REQUEST =
  "PROJECT_CREATE_FEEDBACK_REQUEST";
export const PROJECT_CREATE_FEEDBACK_SUCCESS =
  "PROJECT_CREATE_FEEDBACK_SUCCESS";
export const PROJECT_CREATE_FEEDBACK_FAIL = "PROJECT_CREATE_FEEDBACK_FAIL";
export const PROJECT_CREATE_FEEDBACK_RESET = "PROJECT_CREATE_FEEDBACK_RESET";
